(function() {
  ...
  _.filter = function(collection, test) {
    var result = [];
    // console.log("Using the filter Function:")
  ...
  _.reject = function(collection, test) {
    ...
    // console.log("--------------------------");
    // console.log("Using the Reject Function:");
    var rejectedCollection = [];
    _.filter(collection, function (element) {
      if (!test(element)) {
        rejectedCollection.push(element);
      }
    });
    // console.log("Rejected Collection: ", rejectedCollection);
  ...
  _.uniq = function(array) {
    ...
    // console.log("Entering Unique Function:");
    var result = {};
    var unqiueArray = [];

    _.each(array, function (item) {
      //return unqiueArray[item] === undefined ? unqiueArray.push(item);
      var temp = item;
      if (result[temp] === undefined) {
        result[temp] = 1;
        unqiueArray.push(temp);
      } else {
        result[temp] += 1;
      }
    });
    //console.log("Unqiue Array ", unqiueArray);
    // console.log("Result of Unique Function ", result);
  ...
  _.reduce = function(collection, iterator, accumulator) {
      //console.log("----------------------------");
      // console.log("Entering the Reduce Function");
